...
string variableName;
 ...
 private ProyectoPruebas.ErrorHandler errorHandler;
  ...
  internal ProyectoPruebas.ErrorHandler ErrorHandler { get => errorHandler; set => errorHandler = value; }
	...
	void STATUTE() {
		switch (la.kind) {
		case 6: case 38: case 39: case 40: case 41: case 42: case 43: case 44: case 45: {
			COMMAND();
			break;
		}
		case 10: {
	...
	static readonly bool[,] set = {
		...
		{_x,_T,_x,_T, _x,_x,_T,_x, _x,_x,_T,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_x,_x, _x,_x,_T,_x, _x,_x,_T,_T, _T,_T,_T,_T, _T,_T,_T,_x, _T,_x,_x,_x},
